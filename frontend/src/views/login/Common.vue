<template>
  <div class="container">
    <div class="content">
      <div class="top">
        <div class="header">
          <img alt="logo" src="static/img/logo.png" width="100" height="100"/>
          <br/>
          <span style="font-size: 20px;font-weight: 700">{{systemName}}</span>
        </div>
        <div class="desc"></div>
      </div>
...
<style lang="less" scoped>
  .container {
    ...
    height: 100vh;
    overflow: auto;
    //background: #f0f2f5 url('https://s3.ax1x.com/2021/03/11/6NEEUU.jpg') no-repeat center 110px;
