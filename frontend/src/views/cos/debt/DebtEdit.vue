<template>
  <a-modal v-model="show" title="修改债务债权" @cancel="onClose" :width="800">
...
export default {
  ...
  methods: {
    setFormValues ({...debt}) {
      this.rowId = debt.id
      let fields = ['debtUser', 'price', 'createDate', 'updateDate', 'debtType', 'debtModel', 'content']
      let obj = {}
      ...
      obj['debtType'] = obj['debtType'].toString()
      obj['debtModel'] = obj['debtModel'].toString()
      obj['createDate'] = moment(obj['createDate'])
      obj['updateDate'] = moment(obj['updateDate'])
