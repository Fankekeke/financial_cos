...
export default {
  name: 'insurance',
  components: {InsuranceAdd, InsuranceEdit, RangeDate},
  data () {
    return {
      insuranceAdd: {
        visiable: false
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case 1:
              return <a-tag>人身保险</a-tag>
            case 2:
              return <a-tag>养老保险</a-tag>
            case 3:
              return <a-tag>车险</a-tag>
            default:
              return '- -'
          }
        }
  ...
  methods: {
    ...
    handleinsuranceEditSuccess () {
      this.insuranceEdit.visiable = false
      this.$message.success('修改推荐保险成功')
      this.search()
    },
    view (row) {
      this.insuranceView.data = row
      this.insuranceView.visiable = true
    },
    handleinsuranceViewClose () {
      this.insuranceView.visiable = false
    },
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/recommend-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/recommend-info/page', {
        ...params
      }).then((r) => {
