<template>
  <a-card :bordered="false" class="card-area">
    ...
    <!-- 新增支出 -->
    <expenses-add
      @close="handleExpensesAddClose"
      @success="handleExpensesAddSuccess"
      :expensesAddVisiable="ExpensesAdd.visiable"
    ...
    <expenses-edit
      ref="expensesEdit"
      @close="handleExpensesEditClose"
      @success="handleExpensesEditSuccess"
      :expensesEditVisiable="ExpensesEdit.visiable"
      :consumeTypeData="consumeTypeData">
    </expenses-edit>
  </a-card>
</template>
...
export default {
  name: 'Expenses',
  components: {ExpensesAdd, ExpensesEdit, RangeDate},
  data () {
    return {
      advanced: false,
      ExpensesAdd: {
  ...
  methods: {
    ...
    add () {
      this.ExpensesAdd.visiable = true
    },
    handleExpensesAddClose () {
      this.ExpensesAdd.visiable = false
    },
    handleExpensesAddSuccess () {
      this.ExpensesAdd.visiable = false
      this.$message.success('新增支出成功')
      this.search()
    },
    edit (record) {
      this.$refs.expensesEdit.setFormValues(record)
      this.ExpensesEdit.visiable = true
    },
    handleExpensesEditClose () {
      this.ExpensesEdit.visiable = false
    },
    handleExpensesEditSuccess () {
      this.ExpensesEdit.visiable = false
      this.$message.success('修改支出成功')
      this.search()
    },
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/consume/expenses/page', {
        ...params
      }).then((r) => {
