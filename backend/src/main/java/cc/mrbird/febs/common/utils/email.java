...
public class email {
    ...
    private static String myEmailPsw = "zxsiqpmhxpnydfja";//yonyivmzpseddeae
    ...
    public static void sendEmail(String loginNum, String receiveMailAccount) throws Exception {
        ...
        props.setProperty("mail.smtp.port", "587");             //google使用465或587端口
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String loginNum) throws Exception {
        ...
        message.setSubject("理财通知", "UTF-8");

        // 5. Content: 邮件正文（可以使用html标签）（内容有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改发送内容）
        message.setContent(loginNum, "text/html;charset=utf-8");
